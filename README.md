...
2021.09.01 ~ 2021.12.10 : 5G 기반 디지털 트윈 스마트 항만물류 프로젝트 <br>
 - 터미널 내부의 작업속도와 혼잡도, 터미널 시뮬레이션, 트럭위치 실시간 모니터링, 운송트럭의 최적 경로와 도착시간을 예측하여 터미널 - 배후물류간 항만출입 최적화를 위한 프로젝트<br>
 - 위치관제, 최적 경로와 도착시간 산출 API개발 및 페이지 구현 (네이버 API, 브이월드 API이용)
